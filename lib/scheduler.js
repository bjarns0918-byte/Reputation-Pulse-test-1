...
import { getAllBusinesses, updateBusiness, upsertReview, getReviewsSince } from "./store.js";
...
export async function runDigestForBusiness(business) {
  ...
  const digestText = await buildDigest(recentReviews, business.businessName);
  const html = `
